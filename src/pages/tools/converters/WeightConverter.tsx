...
const units: Unit[] = [
  ...
  { 
    id: 'ton', 
    name: 'US Tons (ton)', 
    toBase: (value) => value * 907185, 
    fromBase: (value) => value / 907185 
  },
  { 
    id: 'ukt', 
    name: 'UK Tons (UK t)', 
    toBase: (value) => value * 1016050, 
    fromBase: (value) => value / 1016050 
  }
];
...
const WeightConverter: React.FC = () => {
  ...
  const [targetUnit, setTargetUnit] = useState<string>('lb');
  ...
  const convertSourceToTarget = (value: string, from: string, to: string) => {
    ...
    // Convert source value to base unit (grams), then to target unit
  ...
  const convertTargetToSource = (value: string, from: string, to: string) => {
    ...
    // Convert target value to base unit (grams), then to source unit
