...
const AreaConverter: React.FC = () => {
  ...
  const [sourceUnit, setSourceUnit] = useState<string>('m2');
  const [targetUnit, setTargetUnit] = useState<string>('ft2');
  ...
  const convertSourceToTarget = (value: string, from: string, to: string) => {
    ...
    // Convert source value to base unit (square meters), then to target unit
  ...
  const convertTargetToSource = (value: string, from: string, to: string) => {
    ...
    // Convert target value to base unit (square meters), then to source unit
